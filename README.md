...
- **Week 3**: Engineered technical indicators (RSI, SMA spreads, volatility), created binary classification target (`Target`), fixed scaler data leakage by enforcing chronological train-test splits, and trained baseline `RandomForestClassifier`.
